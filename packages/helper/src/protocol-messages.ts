...
export const ReceiveMessageTypes = {
  ...
  DAILY_REWARD_ACTION_RESULT: "daily_reward:action_result",
...
export const dailyRewardClaimPayloadSchema = strictObject({
  boostItemId: z.number().nullable(),
});

export const dailyRewardActionResultPayloadSchema = looseObject({
  action: z.string().optional(),
  success: z.boolean().optional(),
  message: z.string().optional(),
  claimedReward: dailyRewardClaimPreviewSchema.optional(),
});
...
export const sendPayloadSchemas = {
  ...
  [SendMessageTypes.DAILY_REWARD_CLAIM]: dailyRewardClaimPayloadSchema,
...
export const receivePayloadSchemas = {
  ...
  [ReceiveMessageTypes.DAILY_REWARD_ACTION_RESULT]: dailyRewardActionResultPayloadSchema,
...
export type DailyRewardClaimPayload = z.infer<typeof dailyRewardClaimPayloadSchema>;
export type DailyRewardActionResultPayload = z.infer<typeof dailyRewardActionResultPayloadSchema>;
