 ...
 *
 * Constants mirror `lib/page-bridge/constants.ts`.
 *
...
const PAGE_BRIDGE_STATUS_ATTR = "data-stonegy-ws-state";
...
(function () {
  ...
  const WS_URL = "wss://api-stonegy.com/";
  ...
  function attachSocket(ws: WebSocket) {
    ...
    post("ws:connected", { url: WS_URL, readyState: ws.readyState });
    publishStatus();
